...
% ode_sir calculates the SIR projections using the given parameters
    ...
    % Interpolate values
    dat.date = datetime(2019,12,23,0,0,0):datetime(2020,7,27,0,0,0);
    ...
    if graph == 1 
        ...
        out.Trep = [out.Trep  tspan-DAYS_PROJECT+1:tspan-DAYS_PROJECT+DAYS_PROJECT]; % Extend simulation for projection
    end
